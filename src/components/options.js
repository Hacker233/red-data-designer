const cptOptions = {
  ...
  chart: {
    ...
    options: {
      ...
      // 漏斗图
      "cpt-chart-funnel-option": {
        cptDataForm: {
          dataSource: 1, // 数据源
          pollTime: 0, // 是否轮询
          dataText:
            '[{ "value": 60, "name": "Visit" },{ "value": 40, "name": "Inquiry" },{ "value": 20, "name": "Order" },{ "value": 80, "name": "Click" },{ "value": 100, "name": "Show" }]', // 原始数据
        },
        // 自定义属性
        attribute: {
          title: "漏斗图",
          trigger: "item",
          formatter: "{a} <br/>{b} : {c}%",
          legend: ["Show", "Click", "Visit", "Inquiry", "Order"],
          name: "Funnel",
          type: "funnel",
          left: "10%",
          top: 60,
      ...
      // 锥形柱状图
      "dataV-conical-option": {
        cptDataForm: {
          dataSource: 1, // 数据源
          pollTime: 0, // 是否轮询
          dataText:
            '[{"name":"周口","value":55},{"name":"南阳","value":120},{"name":"西峡","value":71},{"name":"驻马店","value":66},{"name":"新乡","value":80},{"name":"信阳","value":35},{"name":"漯河","value":15}]', // 原始数据
        },
        attribute: {
          fontSize: 16,
          showValue: true,
